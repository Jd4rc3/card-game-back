...
public class QueryHandle {
  ...
  public RouterFunction<ServerResponse> getTablero() {
    return route(
        GET("/juego/{id}"),
        request -> template.findOne(filterById(request.pathVariable("id")), TableroViewModel.class,
                "gameview")
  ...
  public RouterFunction<ServerResponse> getMazo() {
    return route(
        ...
        request -> template.findOne(
                filterByUidAndId(request.pathVariable("uid"), request.pathVariable("juegoId")),
