package com.example.appservice.handle;

import co.com.sofka.domain.generic.DomainEvent;
import com.example.appservice.generic.EventBus;
import com.example.appservice.generic.EventStoreRepository;
...
public class IntegrationHandle implements Function<Flux<DomainEvent>, Mono<Void>> {
  ...
  public IntegrationHandle(EventStoreRepository repository,
      StoredEvent.EventSerializer eventSerializer, EventBus eventBus) {
